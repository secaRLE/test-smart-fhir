...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.getPatientInfo = function () {
        ...
        // read patient name
        this.smart.patient.read().then(function (patient) {
            _this.patientName = patient.name[0].family + ' ' + patient.name[0].given.join(' ');
        });
        // Search for the current patient's conditions
        this.smart.patient.api.search({ type: 'Condition' })
