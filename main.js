...
var AppComponent = /** @class */ (function () {
    function AppComponent(auth, fhir, _zone) {
        ...
        this.initialize({
            ...
            'scope': 'user/Patient.read user/Observation.read user/Condition.read user/MedicationOrder.read launch online_access openid profile'
